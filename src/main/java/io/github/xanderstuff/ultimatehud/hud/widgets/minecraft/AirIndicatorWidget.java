...
public class AirIndicatorWidget extends Widget {
    public static final Identifier IDENTIFIER = new Identifier("minecraft", "air_indicator");
    private static final AirIndicatorWidget INSTANCE = new AirIndicatorWidget();

    static {
        WidgetRegistry.register(IDENTIFIER, AirIndicatorWidget::getInstance);
    }

    private AirIndicatorWidget() {
        //populate with defaults
    }

    public static AirIndicatorWidget getInstance() {
        return INSTANCE;
    }
